...
var systemLog = {
	system__join: "%user% se ha unido a la sala",
	system__clear: "Esta sala ha sido limpiada por %user%",
	system__name: "%custom% ahora se llama %user%",
	system__kick: "%user% ha sido expulsado",
	system__ban: "%user% ha sido bloqueado",
	system__mute: "%user% ha sido silenciado",
	system__block: "%user% ha sido bloqueado en la sala",
};

var notification = {
	user_join: "Está conectado",
};