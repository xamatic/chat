...
var systemLog = {
	system__join: "%user% has joined the room",
	system__clear: "This room has been cleared by %user%",
	system__name: "%custom% is now known as %user%",
	system__kick: "%user% has been kicked",
	system__ban: "%user% has been banned",
	system__mute: "%user% has been muted",
	system__block: "%user% has been room blocked",
};

var notification = {
	user_join: "Is connected",
}