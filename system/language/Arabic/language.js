...
var systemLog = {
	system__join: "انضم %user% إلى الغرفة",
	system__clear: "تم مسح هذه الغرفة بواسطة %user%",
	system__name: "أصبح %custom% معروفاً الآن باسم %user%",
	system__kick: "تم طرد %user%",
	system__ban: "تم حظر %user%",
	system__mute: "تم كتم %user%",
	system__block: "تم حظر %user% من الغرفة",
};
