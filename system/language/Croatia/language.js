...
var systemLog = {
	system__join: "%user% se pridružio sobi",
	system__clear: "Ovu sobu je očistio %user%",
	system__name: "%custom% je sada poznat kao %user%",
	system__kick: "%user% je izbačen",
	system__ban: "%user% je zabranjen",
	system__mute: "%user% je utišan",
	system__block: "%user% je blokiran u sobi",
};

var notification = {
	user_join: "Povezan je",
};