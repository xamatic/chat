		...
		<div id="public_theme_view_builder" class="public_theme_left_view fhide">
			<div class="public_theme_editor fborder">
				<div class="public_theme_head">
					<div>
						<div class="public_theme_head_title">New Theme</div>
						<div class="public_theme_head_sub">Build and submit your public theme.</div>
					</div>
				...
				<div id="public_theme_builder" data-locked="<?php echo $theme_locked; ?>">
					...
					<div class="public_theme_action_row">
						...
						<?php if(!empty($my_theme)){ ?>
						<button type="button" class="small_button delete_btn" onclick="deletePublicTheme(<?php echo (int) $my_theme['theme_id']; ?>);">Delete</button>
						<?php } ?>
					...
					<div class="public_theme_live_chat">
						<div class="public_theme_live_row">
							...
							<div>
								...
								<div class="public_theme_live_bubble">Live preview while editing.</div>
							</div>
						</div>
					</div>
				</div>
