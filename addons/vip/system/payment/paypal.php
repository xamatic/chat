...
$amount = new Amount();
$amount->setCurrency($addons['custom7'])
	->setTotal($total)
	->setDetails($details);
...
$redirecturls->setReturnUrl($setting['domain'] . '/addons/vip/system/payment/paypal_transaction.php')
	->setCancelUrl($setting['domain'] . '/addons/vip/system/payment/cancel.php');
