...
<div class="top_mod">
	<div class="top_mod_empty pad10">
		<div class="reg_menu">
			<ul>
				<li onclick="giphySelect(1);" class="reg_menu_item rselected" data="giphy_tab" data-z="giphy_gifs"><?php echo $lang['gifs']; ?></li>
...
<div class="btable tmargin5">
	<div class="bcell_mid hpad10">
		<input class="full_input" onkeydown="startGiphySearch(event, this);" placeholder="<?php echo $lang['search']; ?>" id="find_giphy" type="text"/>
	</div>
</div>
