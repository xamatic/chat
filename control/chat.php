...
<div id="global_chat" class="backglob chatheight" >
	...
	<div id="left_menu" class="pheight bleftpan fhide">
		<div id="left_menu_content" class="bsidebar">
			<div id="room_dock_toggle_btn" title="Use Classic Mobile Sidebar" onclick="toggleRoomDockMode();" class="bhover left_menu_item">
				<div class="left_menu_icon">
					<i class="fa fa-columns leftmenui"></i>
				</div>
			</div>
...
<?php
$chat_cache_token = preg_replace('/[^a-zA-Z0-9._-]/', '', (string) $setting['bbfv']);
if($chat_cache_token == ''){
	$chat_cache_token = '1';
}
$chat_cache_force = (strpos($bbfv, '?') === 0) ? '&cv=' . $chat_cache_token : '?cv=' . $chat_cache_token;
?>
